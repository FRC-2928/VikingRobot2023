...
public class Drivetrain extends SubsystemBase {
  ...
  public void setPIDSlot(int slot) {
    int PID_PRIMARY = 0;
    leftLeader.selectProfileSlot(slot, PID_PRIMARY);
    rightLeader.selectProfileSlot(slot, PID_PRIMARY);
  }
